...
class VehicleDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'year' => $this->year,
            'make' => data_get($this, 'vehicle_make.name'),
            'model' => data_get($this, 'vehicle_model.name'),
            'color' => data_get($this, 'vehicle_color.name'),
            'vehicle_make_id' => data_get($this, 'vehicle_make.id'),
            'vehicle_model_id' => data_get($this, 'vehicle_model.id'),
            'vehicle_color_id' => data_get($this, 'vehicle_color.id'),
