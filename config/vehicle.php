...
return [
    ...
    */
    ...
    'statuses' => [
        ...
        ['status' => VehicleStatus::DISPATCHED->value, 'label' => 'Dispatched', 'color' => '#2c51d9', 'logo' => '/images/car_on_the_way.png'],
        ['status' => VehicleStatus::PICKED_UP->value, 'label' => 'Picked Up', 'color' => '#2c51d9', 'logo' => '/images/picked_up.png'],
        ...
        ['status' => VehicleStatus::ARRIVED->value, 'label' => 'Arrived', 'color' => '#2cd9c5', 'logo' => '/images/arrived_cars.png'],
